...
import wavingHand from '../images/header/waving-hand.png'
import css from '../images/header/css.png'
import html from '../images/header/html-5.png'
import react from '../images/header/react.png'
import sass from '../images/header/sass.png'
      ...
      <>
        <div className="header-body" id="home">
          <div className="container">
            <div className="header-body__inner">
              <div className="header-body__greeting">
                ...
                <div className="header-body__greeting-img">
                </div>
              </div>
              <div className="header-body__tech-stack">
                <h3 className="header-body__tech-stack-text">Tech Stack</h3>
                <ul className="header-body__tech-stack-list">
                  <li className="header-body__tech-stack-list-item">
                    <img src={html} alt="html" width={34}/>
                  </li>
                  <li className="header-body__tech-stack-list-item">
                    <img src={css} alt="css" width={34}/>
                  </li>
                  <li className="header-body__tech-stack-list-item">
                    <img src={js} alt="js" width={34}/>
                  </li>
                  <li className="header-body__tech-stack-list-item">
                    <img src={react} alt="react" width={34}/>
                  </li>
                  <li className="header-body__tech-stack-list-item">
